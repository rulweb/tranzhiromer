...
return [
    ...
    */
    ...
    'required_if_accepted' => 'Обязательно для заполнения, когда :other принято',
    'required_if_declined' => 'Обязательно для заполнения, когда :other отклонено',
    ...
    'phone' => 'Неправильный формат мобильного номера',
